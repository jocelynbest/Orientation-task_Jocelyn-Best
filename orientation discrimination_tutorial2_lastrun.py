...
expName = 'orientation discrimination_tutorial2'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Amiel R Best\\Desktop\\orientation discrimination_tutorial2_lastrun.py',
...
trials = data.TrialHandler(nReps=300.0, method='random', 
